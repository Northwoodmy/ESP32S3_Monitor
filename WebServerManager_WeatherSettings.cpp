    ...
    '湖南省': {
        ...
        cities: {
            '长沙市': { 
                code: '430100', 
                districts: {
                    '芙蓉区': '430102', '天心区': '430103', '岳麓区': '430104', 
                    '开福区': '430105', '雨花区': '430111', '望城区': '430112',
                    '长沙县': '430121', '浏阳市': '430181', '宁乡市': '430182'
                } 
            },
            '株洲市': { 
                code: '430200', 
                districts: {
                    '荷塘区': '430202', '芦淞区': '430203', '石峰区': '430204',
                    '天元区': '430211', '渌口区': '430212', '攸县': '430223',
                    '茶陵县': '430224', '炎陵县': '430225', '醴陵市': '430281'
                } 
            },
            '湘潭市': { 
                code: '430300', 
                districts: {
                    '雨湖区': '430302', '岳塘区': '430304', '湘潭县': '430321',
                    '湘乡市': '430381', '韶山市': '430382'
                } 
            },
            '衡阳市': { 
                code: '430400', 
                districts: {
                    '珠晖区': '430405', '雁峰区': '430406', '石鼓区': '430407',
                    '蒸湘区': '430408', '南岳区': '430412', '衡阳县': '430421',
                    '衡南县': '430422', '衡山县': '430423', '衡东县': '430424',
                    '祁东县': '430426', '耒阳市': '430481', '常宁市': '430482'
                } 
            },
            '邵阳市': { 
                code: '430500', 
                districts: {
                    '双清区': '430502', '大祥区': '430503', '北塔区': '430511',
                    '邵东市': '430582', '新邵县': '430522', '邵阳县': '430523',
                    '隆回县': '430524', '洞口县': '430525', '绥宁县': '430527',
                    '新宁县': '430528', '城步苗族自治县': '430529', '武冈市': '430581'
                } 
            },
            '岳阳市': { 
                code: '430600', 
                districts: {
                    '岳阳楼区': '430602', '云溪区': '430603', '君山区': '430611',
                    '岳阳县': '430621', '华容县': '430623', '湘阴县': '430624',
                    '平江县': '430626', '汨罗市': '430681', '临湘市': '430682'
                } 
            },
            '常德市': { 
                code: '430700', 
                districts: {
                    '武陵区': '430702', '鼎城区': '430703', '安乡县': '430721',
                    '汉寿县': '430722', '澧县': '430723', '临澧县': '430724',
                    '桃源县': '430725', '石门县': '430726', '津市市': '430781'
                } 
            },
            '张家界市': { 
                code: '430800', 
                districts: {
                    '永定区': '430802', '武陵源区': '430811', 
            ...
            '益阳市': { 
                code: '430900', 
                districts: {
                    '资阳区': '430902', '赫山区': '430903', '南县': '430921',
                    '桃江县': '430922', '安化县': '430923', '沅江市': '430981'
                } 
            },
            '郴州市': { 
                code: '431000', 
                districts: {
                    '北湖区': '431002', '苏仙区': '431003', '桂阳县': '431021',
                    '宜章县': '431022', '永兴县': '431023', '嘉禾县': '431024',
                    '临武县': '431025', '汝城县': '431026', '桂东县': '431027',
                    '安仁县': '431028', '资兴市': '431081'
                } 
            },
            '永州市': { 
                code: '431100', 
                districts: {
                    '零陵区': '431102', '冷水滩区': '431103', '祁阳市': '431181',
                    '东安县': '431122', '双牌县': '431123', '道县': '431124',
                    '江永县': '431125', '宁远县': '431126', '蓝山县': '431127',
                    '新田县': '431128', '江华瑶族自治县': '431129'
                } 
            },
            '怀化市': { 
                code: '431200', 
                districts: {
                    '鹤城区': '431202', '中方县': '431221', '沅陵县': '431222',
                    '辰溪县': '431223', '溆浦县': '431224', '会同县': '431225',
                    '麻阳苗族自治县': '431226', '新晃侗族自治县': '431227', 
                    '芷江侗族自治县': '431228', '靖州苗族侗族自治县': '431229',
                    '通道侗族自治县': '431230', '洪江市': '431281'
                } 
            },
            '娄底市': { 
                code: '431300', 
                districts: {
                    '娄星区': '431302', '双峰县': '431321', '新化县': '431322',
                    '冷水江市': '431381', '涟源市': '431382'
                } 
            },
            '湘西土家族苗族自治州': { 
                code: '433100', 
                districts: {
                    '吉首市': '433101', '泸溪县': '433122', '凤凰县': '433123',
    ...
    '湖北省': {
        ...
        cities: {
            '武汉市': { 
                code: '420100', 
                districts: {
                    '江岸区': '420102', '江汉区': '420103', '硚口区': '420104',
                    '汉阳区': '420105', '武昌区': '420106', '青山区': '420107',
                    '洪山区': '420111', '东西湖区': '420112', '汉南区': '420113',
                    '蔡甸区': '420114', '江夏区': '420115', '黄陂区': '420116',
                    '新洲区': '420117'
                } 
            },
            '黄石市': { 
                code: '420200', 
                districts: {
                    '黄石港区': '420202', '西塞山区': '420203', '下陆区': '420204',
                    '铁山区': '420205', '阳新县': '420222', '大冶市': '420281'
                } 
            },
            '十堰市': { 
                code: '420300', 
                districts: {
                    '茅箭区': '420302', '张湾区': '420303', '郧阳区': '420304',
                    '郧西县': '420322', '竹山县': '420323', '竹溪县': '420324',
                    '房县': '420325', '丹江口市': '420381'
                } 
            },
            '宜昌市': { 
                code: '420500', 
                districts: {
                    '西陵区': '420502', '伍家岗区': '420503', '点军区': '420504',
                    '猇亭区': '420505', '夷陵区': '420506', '远安县': '420525',
                    '兴山县': '420526', '秭归县': '420527', '长阳土家族自治县': '420528',
                    '五峰土家族自治县': '420529', '宜都市': '420581', '当阳市': '420582',
                    '枝江市': '420583'
                } 
            },
            '襄阳市': { 
                code: '420600', 
                districts: {
                    '襄城区': '420602', '樊城区': '420606', '襄州区': '420607',
                    '南漳县': '420624', '谷城县': '420625', '保康县': '420626',
                    '老河口市': '420682', '枣阳市': '420683', '宜城市': '420684'
                } 
            },
            '鄂州市': { 
                code: '420700', 
                districts: {
                    '梁子湖区': '420702', '华容区': '420703', '鄂城区': '420704'
                } 
            },
            '荆门市': { 
                code: '420800', 
                districts: {
                    '东宝区': '420802', '掇刀区': '420804', '沙洋县': '420822',
                    '钟祥市': '420881', '京山市': '420882'
                } 
            },
            '孝感市': { 
                code: '420900', 
                districts: {
                    '孝南区': '420902', '孝昌县': '420921', '大悟县': '420922',
                    '云梦县': '420923', '应城市': '420981', '安陆市': '420982',
                    '汉川市': '420984'
                } 
            },
            '荆州市': { 
                code: '421000', 
                districts: {
                    '沙市区': '421002', '荆州区': '421003', '公安县': '421022',
                    '监利市': '421083', '江陵县': '421024', '石首市': '421081',
            ...
            '黄冈市': { 
                code: '421100', 
                districts: {
                    '黄州区': '421102', '团风县': '421121', '红安县': '421122',
                    '罗田县': '421123', '英山县': '421124', '浠水县': '421125',
                    '蕲春县': '421126', '黄梅县': '421127', '麻城市': '421181',
                    '武穴市': '421182'
                } 
            },
            '咸宁市': { 
                code: '421200', 
                districts: {
                    '咸安区': '421202', '嘉鱼县': '421221', '通城县': '421222',
                    '崇阳县': '421223', '通山县': '421224', '赤壁市': '421281'
                } 
            },
            '随州市': { 
                code: '421300', 
            ...
            '恩施土家族苗族自治州': { 
                code: '422800', 
                districts: {
                    '恩施市': '422801', '利川市': '422802', '建始县': '422822',
