...
String WebServerManager::getOTAJavaScript() {
    ...
    js += "                \n";
    js += "                // 根据版本比较结果设置UI状态\n";
    js += "                if (data.versionStatus === 'up_to_date') {\n";
    js += "                    // 版本相同，已是最新\n";
    js += "                    serverVersion.style.color = '#10b981';\n";
    js += "                    serverOTABtn.disabled = true;\n";
    js += "                    serverOTABtn.textContent = '已是最新版本';\n";
    js += "                    serverOTABtn.style.backgroundColor = '#9ca3af';\n";
    js += "                    showToast('当前版本已是最新版本', 'info');\n";
    js += "                } else if (data.versionStatus === 'newer') {\n";
    js += "                    // 当前版本更高\n";
    js += "                    serverVersion.style.color = '#f59e0b';\n";
    js += "                    serverOTABtn.disabled = true;\n";
    js += "                    serverOTABtn.textContent = '已是最新版本';\n";
    js += "                    serverOTABtn.style.backgroundColor = '#9ca3af';\n";
    js += "                    showToast('当前版本比服务器版本更新', 'info');\n";
    js += "                } else if (data.versionStatus === 'needs_update') {\n";
    js += "                    // 需要升级\n";
    js += "                    serverVersion.style.color = '#ef4444';\n";
    js += "                    serverOTABtn.disabled = false;\n";
    js += "                    serverOTABtn.textContent = '开始服务器升级';\n";
    js += "                    serverOTABtn.style.backgroundColor = '#10b981';\n";
    js += "                    showToast('发现新版本: ' + data.serverVersion.version + '，可以升级', 'success');\n";
    js += "                } else {\n";
    js += "                    // 未知状态\n";
    js += "                    serverVersion.style.color = '#6b7280';\n";
    js += "                    serverOTABtn.disabled = true;\n";
    js += "                    serverOTABtn.textContent = '版本状态未知';\n";
    js += "                    serverOTABtn.style.backgroundColor = '#9ca3af';\n";
    js += "                    showToast('无法确定版本状态', 'warning');\n";
    js += "                }\n";
    js += "                \n";
    js += "                // 添加版本状态提示信息\n";
    js += "                if (data.versionMessage) {\n";
    js += "                    const versionStatusDiv = document.createElement('div');\n";
    js += "                    versionStatusDiv.className = 'version-status-message';\n";
    js += "                    versionStatusDiv.style.cssText = 'margin-top: 10px; padding: 8px; border-radius: 4px; font-size: 14px;';\n";
    js += "                    \n";
    js += "                    if (data.versionStatus === 'needs_update') {\n";
    js += "                        versionStatusDiv.style.backgroundColor = '#fef3c7';\n";
    js += "                        versionStatusDiv.style.color = '#92400e';\n";
    js += "                        versionStatusDiv.style.border = '1px solid #fbbf24';\n";
    js += "                    } else {\n";
    js += "                        versionStatusDiv.style.backgroundColor = '#f3f4f6';\n";
    js += "                        versionStatusDiv.style.color = '#374151';\n";
    js += "                        versionStatusDiv.style.border = '1px solid #d1d5db';\n";
    js += "                    }\n";
    js += "                    \n";
    js += "                    versionStatusDiv.textContent = data.versionMessage;\n";
    js += "                    \n";
    js += "                    // 移除之前的状态消息\n";
    js += "                    const existingStatus = versionInfo.querySelector('.version-status-message');\n";
    js += "                    if (existingStatus) {\n";
    js += "                        existingStatus.remove();\n";
    js += "                    }\n";
    js += "                    \n";
    js += "                    versionInfo.appendChild(versionStatusDiv);\n";
    js += "                }\n";
    js += "            } else {\n";
    js += "                serverVersion.textContent = '获取失败';\n";
    js += "                serverVersion.style.color = '#ef4444';\n";
    js += "                serverOTABtn.disabled = true;\n";
    js += "                serverOTABtn.textContent = '版本获取失败';\n";
    js += "                serverOTABtn.style.backgroundColor = '#9ca3af';\n";
    js += "            }\n";
    js += "            \n";
